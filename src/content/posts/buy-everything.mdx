...
<Image src={raiseHand} alt="Man raising his hand." width="1080" quality="80" class="rounded-xl max-h-72 w-auto m-auto" />
...
<Image src={coreDomain} alt="Diagram of Strategic Domain Driven Design: Core, Generic and Supporting Domains."
width="1080" quality="80" class="rounded-xl max-h-[560px] m-auto w-auto" />
<span class="text-center block text-sm mt-2 sm:-mt-6 text-subtext0">Chart by [`ddd-crew`](https://github.com/ddd-crew/core-domain-charts?tab=readme-ov-file), licensed under [CC-BY-SA-4.0](https://github.com/ddd-crew/core-domain-charts/blob/ac5e2e4442062a897b027f666d9e9961656bd628/LICENCE.md)</span>
